...
import { eventEnquiry, getCourse, get_privacy, get_terms } from "../Repo/Api";
      ...
      <div style={{ backgroundColor: "#f5a302" }}>
        <div className="bartending-banner">
          ...
          <div className="bartending-banner-absolute-div">
            <h1>School for Bartending ... JOIN NOW!!!</h1>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed,
              sapiente nemo eveniet accusamus doloribus illum beatae fuga itaque
              nisi, iusto maiores repellat minima natus recusandae unde ut
              voluptatibus reiciendis dolores, dicta laboriosam adipisci! Quod,
              dolor nemo adipisci velit vitae pariatur exercitationem! Hic ipsa
              rem porro veniam amet vero aliquid placeat!
            </p>
          </div>
        </div>
              ...
              <div class="search">
                ...
                {showDatePicker ? (
                  <div className="date-picker">
                    ...
                    <button className="submit_button" onClick={() => fetchHandler} >FIND COURSES</button>
                  </div>
                ) : (
                  ""
                )}
