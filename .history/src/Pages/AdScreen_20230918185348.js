    ...
    <>
      <div className="Banner AboutUs addd">
        <div className="content" style={{ width: "80%", margin: "auto" }}>
          <h2 className="permanent-job-heading">
            Launching Our Brand New App! <br />
            VERY SOON !!{" "}
          </h2>
          <p>
      ...
      <div className="About_Us-two_Sec">
        ...
        <div className="right">
          <p style={{ textAlign: "justify" }}>
            ...
            malesuada fames ac turpis egestas. Nulla ultricies diam et felis
            ornare, sit amet posuere eros blandit. Praesent nunc urna, pharetra
            non mauris consectetur, aliquam vestibulum nisi. Mauris tellus
            lectus, ultricies non quam .
          </p>
        </div>
      </div>
    </>
