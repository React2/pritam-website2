...
const AdScreen = () => {
  ...
  const fetchHandler = async () => {
    try{
      const { res } = await axios.get(`https://pritam-backend.vercel.app/api/v1/admin/getAdsById/65043c79269216057dd80a4`)
    }catch{}
  }
    ...
    <>
      <div className="Banner AboutUs addd">
        <div className="content" style={{ width: "80%", margin: "auto" }}>
          ...
          >
            Launching Our Brand New App!
          </h2>
          <h2 className="permanent-job-heading" style={{ fontSize: "42px" }}>
            VERY SOON !!{" "}
          </h2>
          <p>
